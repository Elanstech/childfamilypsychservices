...
class TeamCarousel {
    ...
    getTeamData() {
        return {
            ...
            'jessica-panagiotidis': { name:'Jessica Panagiotidis', credentials:'MS, CRC, LMSW', email:'childfamily12@gmail.com', photo:'Jennifer.jpg',
            ...
            'mercedes-infantes': { name:'Mercedes Infantes', credentials:'Bilingual Mental Health Professional', email:'childfamily12@gmail.com', photo:'mercedes.jpeg',
                bio:['Bilingual mental health professional fluent in Spanish, dedicated to providing culturally responsive and individualized care. I believe each session should be tailored to each client\'s unique needs, goals, life experiences, and cultural background.','I strive to create a supportive and collaborative environment where clients feel heard, respected, and empowered.'],
            ...
            'carla': { name:'Carla Mondelli', credentials:'Marriage and Family Therapist (MFT), Limited Permit', email:'childfamily12@gmail.com', photo:'carlamondelli.jpeg',
                bio:['I am a Marriage and Family Therapist (MFT) practicing under a limited permit. I hold a Bachelor\'s degree in Psychology and a Master\'s degree in Marriage and Family Therapy. My work is grounded in a systemic approach, focusing on how individuals are shaped by their relationships and family dynamics.','I work with individuals, couples, and families to support healthier relationships and emotional well-being. My areas of focus include marital conflict, communication issues, co-parenting challenges, separation and divorce adjustment, and life stressors that impact relationships.','My approach is collaborative and supportive, with an emphasis on helping clients build insight, improve communication, and develop practical tools for change. I strive to provide a safe, nonjudgmental space where clients feel heard and understood.','Whether you are navigating relationship difficulties, parenting transitions, or personal challenges, I aim to support you in creating healthier and more fulfilling connections.'],
